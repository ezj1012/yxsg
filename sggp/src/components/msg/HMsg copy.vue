...
import { onMounted, ref, shallowRef, inject, computed, watch, h, type Component, provide } from 'vue';
...
// const hoverMsgMgr = ref(ctx.hoverMsgMgr)
// provide('msg', { msgMgr: hoverMsgMgr })
...
// watch(hoverMsgMgr, changeComp)
// function changeComp() {
//   var t = hoverMsgMgr.value.hoverMsg
//   if (!t || !t.content) {
//     show.value = false
//     comp.value = emptyEl
//     return;
...
//   const hoverMsg = hoverMsgMgr.value.hoverMsg
//   if (hoverMsg) {
//     let x = hoverMsg.clientX - clientX.value
//     let y = hoverMsg.clientY - clientY.value
